...
<head>
  ...
  <title>{{TITLE}}</title>
  {{MERMAID_SCRIPT}}
  <!-- Mermaid CDN: https://cdn.jsdelivr.net/npm/mermaid@10.9.1/dist/mermaid.min.js -->
  <style>
    ...
    if offline:
        ...
        if os.path.exists(mermaid_js_path):
            ...
            mermaid_script = (
                ...
                '  console.error("Download mermaid.min.js from https://cdn.jsdelivr.net/npm/mermaid@10.9.1/dist/mermaid.min.js");\n'
            ...
            print("  Download it from: https://cdn.jsdelivr.net/npm/mermaid@10.9.1/dist/mermaid.min.js")
